...
exports.editMovie = async (req,res)=>{
    try{
        ...
        console.log(`___ Movie '${updatedMovie.name}' data updated ___`);
        res.status(200).send(updatedMovie);

    }catch(err){
        console.log("___ Error while updating movie data ___ ", err.message);
        res.status(500).send({
...
exports.deleteMovie = async (req,res)=>{
    try{
        ...
        console.log(`___ Movie deleted ___`);
        res.status(200).send({message : "Movie deleted"});

    }catch(err){
        console.log("___ Error while deleting movie ___ ", err.message);
        res.status(500).send({
...
exports.getAllMovies = async (req,res)=>{
    try{
        ...
        console.log("___ Error while getting all movies ___", err.message);
        res.status(500).send({
...
exports.getSingleMovie = async (req,res)=>{
    ...
    try{
        ...
        console.log("___ Error while getting the movie ___", err.message);
        res.status(500).send({
