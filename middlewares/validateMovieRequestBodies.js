...
const allowedMovieGenre = [
    ...
    constants.movieGenre.sci_fi, 
    constants.movieGenre.adventure
]
...
const newMovieBody = (req,res,next)=>{
    try{
        ...
        console.log("____ Error while velidating new movie request body ___ ", err.message);
        res.status(500).send({
...
const editMovieBody = (req,res,next)=>{
    try{
        ...
        console.log("____ Error while velidating edit movie request body ___ ", err.message);
        res.status(500).send({
